...
public class JqmTest extends AbstractJqmTest {
	...
	public void testHeaders() {
		...
		ButtonBuild button1 = Jqm.createButton("My button 1").onClickOpen(next).build();
		page.append(button1);
		next.header("Volgende pagina");
		ButtonBuild button2 = Jqm.createButton("My button 2").onClickOpen(page).build();
		next.append(button2);
		assertEquals(
	...
	public void testMultipage() {
		...
		ButtonBuild button1 = Jqm.createButton("foo").onClickOpen(foo).build();
		page.append(button1);
		ButtonBuild button2 = Jqm.createButton("bar").onClickOpen(bar).build();
		page.append(button2);
		assertEquals(
