...
public class HtmlIntegrationTest extends AbstractTest {
	...
	public void test3() {
		...
		Element body = div.wrap("body").id("my-body")
						 			...
						 			.border("solid 1px black");
		// @formatter:on
		equals("<body id='my-body' style='border:solid 1px black;'><div id='my-div' style='padding:10px;border:solid 1px black;' class='my-class '><h1>my-title</h1></div><br/><hr size='1px'/></body>",
				body);
	}
	...
	public void test6() {
		...
		// @formatter:on
		equals("<body id='my-body' style='border:solid 1px black;'><div id='my-div' style='padding:10px;border:solid 1px black;' class='my-class '><h1>my-title</h1><br/><hr size='1px'/></div></body>",
				content);
	}
