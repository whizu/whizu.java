 ...
 * @author Rudy D'hauwe
 */
@SupportedAnnotationTypes({ ProcessorImpl.HTML_TYPE, ProcessorImpl.MARKDOWN_TYPE })
@SupportedSourceVersion(SourceVersion.RELEASE_7)
public final class ProcessorImpl extends AbstractProcessor {

	protected static final String HTML_TYPE = "org.whizu.annotation.processing.Html";
